    ...
    return (
      <Card style={style.general}>
        ...
        <CardItem style={style.cardItem}>
          ...
          <View style={{flexDirection: 'row'}}><Image source={{uri: 'https://torinit.com/assets/workorbe/Star.png'}} style={{height: 15, width: 15}}/><Text style={style.content}> {rating}</Text></View>
          <Button style={style} content="Book" pressed={() => {Actions.LoginForm()}}/>
        </CardItem>

        <CardItem style={style.cardItem}>
          <View style={{flexDirection: 'row'}}><Image source={{uri: 'https://torinit.com/assets/workorbe/Dollar.png'}} style={{height: 14, width: 7}}/><Text style={style.content}> {rate}</Text></View>
